...
public:
	...
	const std::string nameFirst() const { return nameFirst_; }
	const std::string nameLast() const { return nameLast_; }
	int const category() const;
	const bool registery() const { return register_; }
